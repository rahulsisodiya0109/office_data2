...
/**
 * This class contains a collection of helper methods that can be used to
 * compliment the TestLink API available methods.
 * 
 */
public class TestLinkAPIHelper implements TestLinkAPIConst {
	 ...
	 * @throws TestLinkAPIException
	 */
	public static Integer getSuiteID(TestLinkAPIClient apiClient, String projectName, String suiteName)
			throws TestLinkAPIException {
		Integer projectID = getProjectID(apiClient, projectName);
		return getSuiteID(apiClient, projectID, suiteName);
	}

	public static Map getSuiteInfo(TestLinkAPIClient apiClient, String projectName, String suiteName)
			throws TestLinkAPIException {
		Integer projectID = getProjectID(apiClient, projectName);
	 ...
	 * @throws TestLinkAPIException
	 */
	public static Integer getSuiteID(TestLinkAPIClient apiClient, Integer projectID, String suiteName)
			throws TestLinkAPIException {
	 ...
	 * @throws TestLinkAPIException
	 */
	public static Map getSuiteInfo(TestLinkAPIClient apiClient, Integer projectID, String suiteName)
			throws TestLinkAPIException {
	...
	public static String getCaseVisibleID(TestLinkAPIClient apiClient, String projectName, String caseName)
			throws TestLinkAPIException {
	...
	public static Integer getTestCaseID(TestLinkAPIClient apiClient, Integer projectID, String testCaseNameOrVisibleID)
			throws TestLinkAPIException {
		Integer caseID = null;
		try {
	 ...
	 * @throws TestLinkAPIException
	 */
	public static Integer getCaseIDByName(TestLinkAPIClient apiClient, Integer projectID, String caseName)
			throws TestLinkAPIException {
	...
	/**
	 * Get the a test case identifier by test project id, suite id and test case
	 * name.
	 * 
	 * @param apiClient
	 * @param projectID
	 ...
	 * @throws TestLinkAPIException
	 */
	public static Integer getCaseIDByName(TestLinkAPIClient apiClient, Integer projectID, Integer suiteID,
	...
	public static Integer getCaseIDByVisibleID(TestLinkAPIClient apiClient, Integer projectID, String caseName)
			throws TestLinkAPIException {
		ArrayList cases = new ArrayList();
		...
		for (int i = 0; i < results.size(); i++) {
			Object id = results.getValueByName(i, API_RESULT_IDENTIFIER);
			if (id != null) {
				addAllMatchingCases(apiClient, cases, projectID, new Integer(id.toString()), caseName, prefix, true);
			}
		}
		Map data = getLatestVersionCaseID(cases);
		return getIdentifier(data);
	...
	/**
	 * Find the matching test case information and add it to the array list passes
	 * as a parameter.
	 * 
	 * @param apiClient
	 * @param cases
	 ...
	 * @throws TestLinkAPIException
	 */
	private static void addAllMatchingCases(TestLinkAPIClient apiClient, ArrayList cases, Integer projectID,
			Integer suiteID, String casePattern, String prefix, boolean useVisibleID) throws TestLinkAPIException {
	 ...
	 * @throws TestLinkAPIException
	 */
	public static Map getTestCaseInfo(TestLinkAPIClient apiClient, Integer projectID, Integer testCaseID)
			throws TestLinkAPIException {
	...
	/**
	 * Get the latest version for the test cases passed in the array. The method
	 * assumes these are the results of all cases within a suite or project that
	 * matched a specific case name.
	 * 
	 * @param cases
	 * @return
	 */
	 ...
	 * @throws TestLinkAPIException
	 */
	public static Integer getPlanID(TestLinkAPIClient apiClient, Integer projectID, String planName)
			throws TestLinkAPIException {
		Object id = null;
		Integer planID = null;
	 ...
	 * @throws TestLinkAPIException
	 */
	public static Map getPlanInfo(TestLinkAPIClient apiClient, Integer projectID, String planName)
			throws TestLinkAPIException {
	 ...
	 * @throws TestLinkAPIException
	 */
	public static Integer getBuildID(TestLinkAPIClient apiClient, Integer planID, String buildName)
			throws TestLinkAPIException {
	 ...
	 * @throws TestLinkAPIException
	 */
	public static Map getBuildInfo(TestLinkAPIClient apiClient, Integer planID, String buildName)
			throws TestLinkAPIException {
