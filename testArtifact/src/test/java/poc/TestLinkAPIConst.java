...
public interface TestLinkAPIConst {
	...
	/*
	 * Methods supported by TestLink 1.8.2 based on the PHP sample implementation of
	 * the TestLink API
	 */
	...
	/*
	 * Parameter names supported by TestLink 1.8.2 based on PHP sample
	 * implementation of TestLinkAPI
	 */
	...
	/*
	 * Values being returned in the map based on inspection and unless documented
	 * may change it would have to be retested.
	 */
	...
	/*
	 * Readability constants. TestLink can change any of these variables at their
	 * discretion but this is what they seem to currently use for their API values.
	 */
	 ...
	 */
	@SuppressWarnings("removal")	//CHECK THIS LATER
